...
public class Word {
     ...
     */
    public Word(String DescriptionOfHeader, String HeaderText, int imageResourceId, String positionOnMap) {
     ...
     * Create a new object.
     */
    public Word(String HeaderText, String DescriptionOfHeader, String positionOnMap, int imageResourceId) {
        mHeaderText = HeaderText;
        mDescriptionOfHeader = DescriptionOfHeader;
        mImageResourceId = imageResourceId;
        mPositionOnMap = positionOnMap;
