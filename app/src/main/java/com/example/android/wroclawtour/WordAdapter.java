...
public class WordAdapter extends ArrayAdapter<Word> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // Get the header translation from the currentWord object and set this text on
        // the header TextView.
        headerTextView.setText(currentWord.getDescriptionOfHeader());
        ...
        defaultTextView.setText(currentWord.getHeaderText());
